    	...
    	<div id="outside_container">
            ...
            <div class="container">
               ...
               <div class="prodContainer">
                 ...
                 <div class="prodMain">
                        <div class="prodCont">
                        		<h2>Twin Over Twin with 2 Chests</h2><h3>With Platform Bed #22-827</h3>
                                <br />
                                <p>This system was designed as an excellent environment for two kids. Fourteen Deep Drawers provide an incredible amount of storage space. The Twin Platform Bed offers an Under-bed Storage Drawer and a Headboard Bookcase with fluorescent light fixture. An alarm clock, books, toys, and other gadgets can be stored comfortably on the Bookshelves behind the chests. Berg's Signature Staircase provides easy and safe access to the top bed. Stairs can be installed on either the left or right side.</p>
                                <p>&nbsp;</p>
                          <br />
                                <h3>Features</h3>
                                <br />
                                <ul>
                                	<li>(2) 5 Drawer Chests</li>
                                    <li>Bookshelves</li>
                                    <li>2 Twin Beds</li>
                            ...
                            <a class="prevPage browse left"></a>
                            	<div class="scrollable">
                                	<div class="items">
                                        ...
                                        <img src="img/MainProdPics/22-827D_t.jpg" 
                                        ...
                                        <img src="img/MainProdPics/22-827C_t.jpg" 
                                        title="Shown in White with Antique Pewter Knobs; <b><i>Optional</b> Hanging Shelf</i>"/>
                                        
                                        <img src="img/MainProdPics/Detail-24_t.jpg" 
                                        title="Two Chests with Extra Deep Drawers provide plenty room for your things." />
                                        
                                        <img src="img/MainProdPics/Detail-22_t.jpg" 
                    ...
                    <div class="prodFtr">
                        ...
                        <div id="thisColl"><b><a href="/space_savers.php">All Space Savers</a></b>
                              ...
                              <ul>
                                  ...
                                  <li style="background-color:#01adf7;"><b>22-827</b> Twin/Twin w/ Platform Bed</li>
                              </ul>
                        </div>
