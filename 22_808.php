...
<title>Berg Furniture | Space Saver | 22&ndash;808</title>
</head>
	<body>
    	<div id="outside_container">
            ...
            <div class="container">
               ...
               <div class="prodContainer">
                 ...
                 <div class="prodMain">
                        <div class="prodCont">
                        		<h2>Twin Loft with Desk &amp; 2 Chests</h2><h3>#22-808</h3>
                                <br />
                                <p> If storage is your priority, then behold the Berg's Space Saver!  A pair of 5-drawer chests with reverse-side bookshelves set the tone for the room that can store it all. The 4-Drawer Desk with a fluorescent light can be pulled forward to accommodate growing children. The optional Hanging Shelf is a handy add-on for the loft bed and Berg's Signature Staircase provides even more storage, plus easy and safe access to the top bed.  Stairs can be installed on either the left or right side.
                                </p>
                                <br />
                                <h3>Features</h3>
                                <br />
                                ...
                                <div class="dimensions"><img src="img/dimbkg.png"/>
                                    ...
                                    <div style="top:40px; left: 40px;">49"D</div>
                   	 ...
                   	 <div class="imgWrap">
                            ...
                            <a class="prevPage browse left"></a>
                            	<div class="scrollable">
                                	<div class="items">
                                    	<img src="img/MainProdPics/22-808A_t.jpg" 
                    ...
                    <div class="prodFtr">
                        ...
                        <div id="thisColl"><b><a href="/space_savers.php">All Space Savers</a></b>
                              ...
                              <ul>
                                  ...
                                  <li style="background-color:#01adf7;"><b>22-808</b> Twin Loft w/Desk &amp; 2 Chests</li>
